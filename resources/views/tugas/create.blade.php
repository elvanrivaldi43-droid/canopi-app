...
<div class="container" style="max-width:720px; margin:0 auto; padding:16px;">
    <div style="margin-bottom:16px;">
        <a href="{{ route('tugas.index') }}" style="color:#94a3b8; font-size:0.85rem; text-decoration:none;">
    ...
    <div class="form-card">
        <h2 class="form-title">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-3px; margin-right:8px;"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            Buat Tugas Baru
        </h2>

        <form method="POST" action="{{ route('tugas.store') }}" id="formTugas">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul" class="form-control"
                       placeholder="Contoh: Pasang rangka kanopi – Pak Budi, Alam Sutera"
            ...
            {{-- Jam Mulai & Target Selesai — dropdown --}}
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="hidden" name="jam_mulai" id="jam_mulai_val" value="{{ old('jam_mulai') }}">
                </div>
                <div class="form-group">
                    ...
                    <input type="hidden" name="jam_selesai_target" id="jam_selesai_val" value="{{ old('jam_selesai_target') }}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="lokasi" class="form-control"
                       placeholder="Contoh: Workshop, Alam Sutera Blok A3, dll"
                       value="{{ old('lokasi') }}">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control"
                          placeholder="Tulis detail instruksi tugas di sini...">{{ old('deskripsi') }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="select-all-bar">
                    ...
                    <span class="selected-count" id="countLabel">0 dipilih</span>
                </div>

                <div class="karyawan-grid" id="karyawanGrid">
                    @foreach($karyawan as $k)
                    <div class="karyawan-chip {{ in_array($k->id, old('karyawan_ids', [])) ? 'checked' : '' }}"
                         data-id="{{ $k->id }}">
            ...
            <div class="form-actions">
                <a href="{{ route('tugas.index') }}" class="btn-cancel">Batal</a>
