...
<a href="#" class="nav-item">
    ...
    <span x-show="sidebarOpen">RAB & Quotation</span>
</a>
...
<a href="{{ route('absensi.rekap-bulanan') }}" class="sidebar-item {{ request()->routeIs('absensi.rekap-bulanan') ? 'active' : '' }}">
    <span style="font-size:16px;width:20px;display:inline-block;">📅</span>
    Rekap Bulanan
</a>
<a href="{{ route('izin.approval') }}" class="sidebar-item {{ request()->routeIs('izin.*') ? 'active' : '' }}">
    <span style="font-size:16px; width:20px; display:inline-block;">ðŸ“‹</span>
    Izin
</a>
